...
const Gellery = () => {
	...
	return (
		<section className="relative w-full min-h-screen bg-gradient-to-b from-sky-300 via-sky-100 to-sky-50 overflow-hidden">
			...
			<div className="relative z-10">
				...
				<div className="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center flex items-center justify-center min-h-[80px] pt-8 pb-12 mt-8 mb-8">
					...
					>
						<span className="block w-full px-10 py-6 rounded-2xl text-black lg:inline">
