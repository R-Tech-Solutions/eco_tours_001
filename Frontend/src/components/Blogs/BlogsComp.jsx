  ...
  return (
    <>
      <div 
        ...
        style={{
          background: "linear-gradient(to bottom, #E0F6FF, #F0F8FF, #F8FBFF)",
          backgroundColor: '#E0F6FF'
        }}
      >
        <section data-aos="fade-up" className="container">
          <h1 className="my-8 border-l-8 border-blue-500/50 py-2 pl-2 text-3xl font-bold text-black drop-shadow-lg">
            Our Latest Blogs
          </h1>
